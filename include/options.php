...
<div class="accordion" id="collapseSettings">
    ...
    <button class="mb-2 btn btn-outline-primary btn-lg btn-block text-start text-left<?php echo $rounded_btn_opt; ?>" type="button" data-bs-toggle="collapse" data-toggle="collapse" data-bs-target="#collapseColors" data-target="#collapseColors">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="collapse show" id="collapse-background">
                        <input type="text" class="form-control qrcolorpicker colorpickerback rounded-0" value="<?php echo $stringbackcolor; ?>" name="backcolor">
                    </div>
                </div>
            </div>
            <div class="custom-control custom-switch mt-2">
              <input type="checkbox" class="custom-control-input collapse-control-reversed" id="trans-bg" name="transparent" data-bs-target="#collapse-background" data-target="#collapse-background">
        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control qrcolorpicker rounded-0" value="<?php echo $stringfrontcolor; ?>" name="frontcolor">
    ...
    <div class="accordion-item d-grid">
    <button class="mb-2 btn btn-outline-primary btn-lg btn-block text-start text-left<?php echo $rounded_btn_opt; ?>" type="button" data-bs-toggle="collapse" data-toggle="collapse" data-bs-target="#collapseStyle" data-target="#collapseStyle">
    ...
    <div class="collapse<?php echo $collapsed; ?>" id="collapseStyle"<?php echo $accordion_parent; ?>>
        ...
        foreach ($markers as $marker => $values) {
            ...
            $markerselecta .= '<label class="btn btn-light p-1">
                <input type="radio" name="marker" value="'.$marker.'" '.$activeattr.' class="btn-check">
    ...
    */
    ...
    if (qrcdr()->getConfig('uploader') == true || $count > 0) {
        ...
        foreach ($watermarks as $key => $water) {
            ...
            $listwatermarks .= ' id="optionlogo'.$key.'" class="btn-check"><img src="'.$water.'"></label>';
        }
        ?>
    ...
    <button class="mb-2 btn btn-outline-primary btn-lg btn-block text-start text-left<?php echo $rounded_btn_opt; ?>" type="button" data-bs-toggle="collapse" data-toggle="collapse" data-bs-target="#collapseFrame" data-target="#collapseFrame">
    ...
    <div class="accordion-item d-grid">
    <button class="mb-2 btn btn-outline-primary btn-lg btn-block text-start text-left<?php echo $rounded_btn_opt; ?>" type="button" data-bs-toggle="collapse" data-toggle="collapse" data-bs-target="#collapseOptions" data-target="#collapseOptions">
